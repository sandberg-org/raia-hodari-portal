...
export const translations: Translations = {
  ...
  fr: {
    ...
    "services.tempDrivingLicense": "Permis de Conduite Temporaire",
    "services.tempDrivingLicense.desc": "Obtenez un certificat de permis de conduite temporaire de 15 jours en attendant votre duplicata.",
    "services.access": "Accéder au Service",
    
    // Temporary Driving License page
    "tempLicense.title": "Certificat de Permis de Conduire Temporaire",
    "tempLicense.subtitle": "Obtenez un certificat de permis de conduite temporaire de 15 jours si vous avez demandé un duplicata",
    ...
    "tempLicense.eligible": "Vous êtes éligible pour un certificat de permis de conduite temporaire",
